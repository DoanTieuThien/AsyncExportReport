...
public class ExecureRegisterCommandThread extends ThreadAbstractBase {
	/*
	 * log4j
	 */
	private static final Logger log = LoggerFactory.getLogger(ExecureRegisterCommandThread.class);
